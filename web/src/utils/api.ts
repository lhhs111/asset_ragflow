...
export default {
  ...
  document_thumbnails: `${api_host}/document/na/thumbnails`,
  // document_thumbnailsNa: `${api_host}/document/na/thumbnails`,
  get_document_file: `${api_host}/document/get`,
  document_upload: `${api_host}/document/upload`,
  web_crawl: `${api_host}/document/web_crawl`,
  document_infos: `${api_host}/document/na/infos`,
  // document_infosNa: `${api_host}/document/na/infos`,
  upload_and_parse: `${api_host}/document/na/upload_and_parse`,
  // upload_and_parseNa: `${api_host}/document/na/upload_and_parse`,
  ...
  setConversation: `${api_host}/conversation/na/set`,
  // setConversationNa: `${api_host}/conversation/na/set`,
  getConversation: `${api_host}/conversation/na/get`,
  // getConversationNa: `${api_host}/conversation/na/get`,
  getConversationSSE: `${api_host}/conversation/getsse`,
  listConversation: `${api_host}/conversation/list`,
  // listConversationNa: `${api_host}/conversation/na/list`,
  removeConversation: `${api_host}/conversation/na/rm`,
  // removeConversationNa: `${api_host}/conversation/na/rm`,
  completeConversation: `${api_host}/conversation/na/completion`,
  // completeConversationNa: `${api_host}/conversation/na/completion`,
  deleteMessage: `${api_host}/conversation/na/delete_msg`,
  // deleteMessageNa: `${api_host}/conversation/na/delete_msg`,
  thumbup: `${api_host}/conversation/na/thumbup`,
  // thumbupNa: `${api_host}/conversation/na/thumbup`,
