...
@manager.route("/na/upload", methods=["POST"])  # noqa: F821
...
@manager.route("/na/web_crawl", methods=["POST"])  # noqa: F821
...
@manager.route("/na/create", methods=["POST"])  # noqa: F821
...
@manager.route("/na/list", methods=["POST"])  # noqa: F821
...
@manager.route("/na/infos", methods=["POST"])  # noqa: F821
...
@manager.route("/na/thumbnails", methods=["GET"])  # noqa: F821
# 
def thumbnails():
...
@manager.route("/na/change_status", methods=["POST"])  # noqa: F821
...
@manager.route("/na/rm", methods=["POST"])  # noqa: F821
...
@manager.route("/na/run", methods=["POST"])  # noqa: F821
...
@manager.route("/na/rename", methods=["POST"])  # noqa: F821
...
@manager.route("/na/get/<doc_id>", methods=["GET"])  # noqa: F821
# 
def get(doc_id):
    try:
        e, doc = DocumentService.get_by_id(doc_id)
...
@manager.route("/na/change_parser", methods=["POST"])  # noqa: F821
...
@manager.route("/na/image/<image_id>", methods=["GET"])  # noqa: F821
# 
...
@manager.route("/na/upload_and_parse", methods=["POST"])  # noqa: F821
...
@manager.route("/na/parse", methods=["POST"])  # noqa: F821
...
@manager.route("/na/set_meta", methods=["POST"])  # noqa: F821
