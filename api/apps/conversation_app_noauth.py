...
@manager.route("/na/set", methods=["POST"])  # noqa: F821
...
@manager.route("/na/get", methods=["GET"])  # noqa: F821
def get():
...
@manager.route("/na/getsse/<dialog_id>", methods=["GET"])  # type: ignore # noqa: F821
...
@manager.route("/na/list", methods=["GET"])  # noqa: F821
...
@manager.route("/na/completion", methods=["POST"])  # noqa: F821
...
@manager.route("/na/tts", methods=["POST"])  # noqa: F821
def tts():
    req = request.json
    text = req["text"]
...
@manager.route("/na/delete_msg", methods=["POST"])  # noqa: F821
...
@manager.route("/na/thumbup", methods=["POST"])  # noqa: F821
@validate_request("conversation_id", "message_id")
def thumbup():
    req = request.json
    e, conv = ConversationService.get_by_id(req["conversation_id"])
...
@manager.route("/na/ask", methods=["POST"])  # noqa: F821
...
@manager.route("/na/mindmap", methods=["POST"])  # noqa: F821
@validate_request("question", "kb_ids")
def mindmap():
    req = request.json
    kb_ids = req["kb_ids"]
...
@manager.route("/na/related_questions", methods=["POST"])  # noqa: F821
